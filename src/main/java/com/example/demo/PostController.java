...
public class PostController {
    ...
    @GetMapping("/{postId}")
    public Post getPostById(@PathVariable Long postId) throws Exception { return postService.getPostById(postId); }
    ...
    public Post updatePost(@PathVariable Long postId, Post post) { return postService.updatePost(postId, post); }
